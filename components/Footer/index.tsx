...
import Brand from "@/public/assets/plotigo-favicon-rev.svg";
      ...
      <div className="container flex items-start phone:flex-col phone:items-center phone:gap-6 w-full py-10 justify-between">
        <div className="brands flex flex-col gap-4 w-full">
          <Image
            src={Brand}
            alt="plotigo"
            className="w-[8em] phone:w-[7rem] h-auto"
            loading="lazy"
          />
          ...
          <p className="text-sm text-[#555]">Feel free to contact us</p>
                ...
                <div className="footer__link flex gap-4 w-full justify-between">
                    ...
                    <div className="footer__link">
                        <div className="link__heading mb-2">
                            <h2 className="uppercase font-bold text-xl phone:text-base text-[#333]">PROJECTS</h2>
                        </div>
                        <div className="items flex flex-col gap-1 text-base text-[#888]">
                            <Item href="">Employee Transport</Item>
                            <Item href="">School Bus</Item>
                            <Item href="">Airport Shuttle</Item>
                        </div>
                    </div>

          <div className="footer__link">
            <div className="link__heading mb-2">
              <h2 className="uppercase font-bold text-xl phone:text-base text-[#333]">
                LEGAL
              </h2>
            </div>
            <div className="items flex flex-col gap-1 text-base text-[#888]">
