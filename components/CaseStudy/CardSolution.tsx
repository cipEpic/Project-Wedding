...
export default function ChallengeSolution({ src, alt = "", text = "" }: IProps) {
  ...
  return (
    ...
    >
      <div className="flip-card-front absolute flex flex-col items-center">
        <div className="px-[14px] opacity-90 phone:px-[11px]  flex items-center">
          <Image
            src={src}
            alt=""
